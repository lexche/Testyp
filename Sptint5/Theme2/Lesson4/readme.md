...
В этом уроке мы узнали, что такое маршрутизация и маршрутизаторы, какие они бывают, как передают данные и зачем они нужны в сети. В чём их отличие от коммутатоов. Узнали какие инструменты есть для диагностики и анализа проблем в сети и методы решения этих проблем. Кроме того, мы отработали в симуляторе ситуацию, когда с помощью маршрутизатора нужно соединить 2 локальные сети.

В следующем уроке научимся соединять между собой маршрутизаторы.
