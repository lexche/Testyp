...
В сети интернет много статей и видео по этому инструменту, где более подробно показаны примеры различных фильтров и их применения, к тому же есть интуитивно понятный графический интерфейс.
