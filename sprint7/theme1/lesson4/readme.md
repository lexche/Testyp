...
1. Какой протокол обеспечивает передачу блочных данных в сети хранения SAN через специальное оборудование?
   ...
   - Правильный ответ: D) Fibre Channel Protocol
   - Объяснение: Fibre Channel Protocol используется для передачи блочных данных в сетях хранения SAN через специальное оборудование Fibre Channel.
...
2. Какой протокол обеспечивает доступ к файлам и каталогам на удалённом сервере?
   ...
   - C) NFS
   - D) SMB
   - Правильный ответ: C) NFS
   - Объяснение: NFS (Network File System) предоставляет возможность доступа к файлам и каталогам на удалённом сервере.
...
3. Какой протокол обычно используется для подключения блочных устройств хранения, таких как диски или тома, к удалённым серверам?
   ...
   - C) NFS
   - D) Fibre Channel Protocol
   - Правильный ответ: B) iSCSI
   - Объяснение: iSCSI часто используется для подключения блочных устройств хранения к удалённым серверам через сеть TCP/IP.
...
4.  Какой из протоколов обеспечивает доступ к файлам и принтерам в сетях Windows?
   ...
   - D) SMB
   - Правильный ответ: D) SMB
   - Объяснение: SMB (Server Message Block) используется для обмена файлами и принтерами в сетях Windows.
