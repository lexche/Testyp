...
c) HTTP
d) SMTP
Правильный ответ: a) ISCSI
Объяснение: ISCSI предназначен для передачи блочных данных, в то время как NFS - файловый протокол, предназначенный для передачи файлов.
