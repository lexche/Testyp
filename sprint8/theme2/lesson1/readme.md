...
В этом уроке вы узнали что такое нереляционные базы данных, почему в них появилась необходимость, отличия от реляционные баз данных, какие виды реляционных баз данных существуют. Во второй части урока мы подробно рассмотрели MongoDB -  документо-ориентированную нереляционную БД. Узнали какие версии этой БД были и чем они отличались, в чём особенности MongoDB, какие есть достоинства и недостатки у данного типа БД.
