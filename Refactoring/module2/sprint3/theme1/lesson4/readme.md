...
## Прим. автора. Подводку оставил ту, которая была, убрал часть про сервисы. Если нужна ссылка на предыдущие уроки, то дайте мне ссылки(можно в тикет накидать в хронологическом порядке) на все написанные уроки, которые идут перед ним. Не исходники, а то что уже сейчас написано\переписано.

Теперь разберёмся, как происходит загрузка ОС после нажатия кнопки включения.
