...
На складе есть металлические стеллажи с товарами, руководство хочет просматривать, что находится между стеллажами и опробовать беспроводные терминалы для сборки заказов, поэтому наша задача спроектировать локальную сеть для видеонаблюдения и wi-fi сети. На территории склада есть 2 коммутационных ящика, соединённых оптическим кабелем. 

На складе в офисной части 10 рабочих мест 2 МФУ, планируется установить 14 камер и 10 Wi-Fi точек доступа.

Из офиса после оптимизации бюджета пришло:

### Практическое задание.

Объясните как обеспечить связью склад филиала?

У вас есть 3 ящика: 1 в филиале 2 на складе. определите какое оборудование для какого ящика предназначено, чтобы функционировало всё оборудование работало.
